...
class Sportsman
{
    ...
    public:
        Sportsman(const std::string& firstName, const std::string& lastName, int age)
            ...
            {
                std::cout << "The Sportsman constructor has been invoked" << std::endl;
            }

        Sportsman(const Sportsman& s)
            : firstName(s.firstName), lastName(s.lastName), age(s.age)
            {
                std::cout << "The Sportsman COPY constructor has been invoked" << std::endl;
            }
        ...
        Sportsman(Sportsman&& s)
            ...
            {
                std::cout << "The Sportsman MOVE constructor has been invoked" << std::endl;
            }
...
class FootballPlayer : public Sportsman
{
    ...
    public:
        FootballPlayer(const std::string& firstName, const std::string& lastName, int age, const std::string& position, const std::string& team)
            ...
            {
                std::cout << "The FootballPlayer constructor has been invoked" << std::endl;
            }

        FootballPlayer(const FootballPlayer& f)
            : Sportsman(f), position(f.position), team(f.team), goals(f.goals)
            {
                std::cout << "The FootballPlayer COPY constructor has been invoked" << std::endl;
            }
        ...
        FootballPlayer(FootballPlayer&& f)
            ...
            {
                std::cout << "The FootballPlayer MOVE constructor has been invoked" << std::endl;
            }
...
int main()
{
    ...
    std::cout << "CONSTRUCTORS ZONE DONE!" << std::endl << std::endl;
